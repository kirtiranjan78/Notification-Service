package com.mindfire.notificationService.service.impl;
...
import com.mindfire.notificationService.util.HtmlEmailBodyUtility;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendPasswordResetEmail(UserNotificationEvent userDetails) throws MessagingException {
    ...
    @Override
    public void sendCertificateGenerationEmail(CertificateNotificationEvent certificateNotificationEvent) throws MessagingException {
        String tenet = "MINDFIRE SOLUTIONS";

        String emailContent = HtmlEmailBodyUtility.getTemplateBodyForAchievementMail();
        String finalEmail = String.format(emailContent, certificateNotificationEvent.getFirstName(), tenet);

        sendEmail(certificateNotificationEvent.getEmail(), "Congratulations from mindfire solutions", finalEmail, true);
    }
